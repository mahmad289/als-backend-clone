...
@Injectable()
export class FullComplianceReport implements IReportService {
  constructor(
  ...
  async advanceFilter(
    body: FullComplianceReportCreator,
  ...
  async create(body: FullComplianceReportCreator): Promise<any> {
    try {
  ...
  groupByCoverageType = (
    ...
    complianceItems.forEach(item => {
      ...
      groupedItems[coverage_type].policy_number = item.policy_number
        ? item.policy_number
        : '';
      groupedItems[coverage_type].carrier = item.carrier ? item.carrier : '';
